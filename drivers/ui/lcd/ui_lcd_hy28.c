...
//*----------------------------------------------------------------------------
//* Function Name       : UiLcdHy28_NewParallelInit
//* Object              : new init routines for 9324 controller that apparently
//* Object              : has four revisions (A,B,C and D)
//* Input Parameters    :
//* Output Parameters   :
//* Functions called    :
//*----------------------------------------------------------------------------
void UiLcdHy28_NewParallelInit(void)
{
	...
	UiLcdHy28_WriteReg(0x12, 0x001F);

	//delay_ms(50); /* Delay 50ms */
	UiLcdHy28_Delay(50000);

	UiLcdHy28_WriteReg(0x13, 0x1500); /* VDV[4:0] for VCOM amplitude */
	UiLcdHy28_WriteReg(0x29, 0x0027); /* 04 VCM[5:0] for VCOMH */
	UiLcdHy28_WriteReg(0x2B, 0x000D); /* Set Frame Rate */
